...
max_jobs=100 # Установите это значение в зависимости от количества потоков вашего процессора
...
for i in {1..10}; do
    for j in {1..10}; do
        for k in {1..10}; do
            ...
            go run . -buffer "$i" -teachers "$j" -maxload "$k" -lambda 5 -interval 0.5 > "$filename" &
